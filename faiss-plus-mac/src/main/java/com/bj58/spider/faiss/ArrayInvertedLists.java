...
public class ArrayInvertedLists extends InvertedLists {
  ...
  public void setIds(SWIGTYPE_p_std__vectorT_std__vectorT_long_long_t_t value) {
    swigfaissJNI.ArrayInvertedLists_ids_set(swigCPtr, this, SWIGTYPE_p_std__vectorT_std__vectorT_long_long_t_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__vectorT_std__vectorT_long_long_t_t getIds() {
  ...
  public long add_entries(long list_no, long n_entry, SWIGTYPE_p_long_long ids, SWIGTYPE_p_unsigned_char code) {
    return swigfaissJNI.ArrayInvertedLists_add_entries(swigCPtr, this, list_no, n_entry, SWIGTYPE_p_long_long.getCPtr(ids), SWIGTYPE_p_unsigned_char.getCPtr(code));
  }

  public void update_entries(long list_no, long offset, long n_entry, SWIGTYPE_p_long_long ids, SWIGTYPE_p_unsigned_char code) {
    swigfaissJNI.ArrayInvertedLists_update_entries(swigCPtr, this, list_no, offset, n_entry, SWIGTYPE_p_long_long.getCPtr(ids), SWIGTYPE_p_unsigned_char.getCPtr(code));
  }
