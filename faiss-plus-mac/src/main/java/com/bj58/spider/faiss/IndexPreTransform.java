...
public class IndexPreTransform extends Index {
  ...
  public void setIndex(Index value) {
    swigfaissJNI.IndexPreTransform_index_set(swigCPtr, this, Index.getCPtr(value), value);
  }
  ...
  public IndexPreTransform(Index index) {
    this(swigfaissJNI.new_IndexPreTransform__SWIG_0(Index.getCPtr(index), index), true);
  }
  ...
  public void add_with_ids(long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long xids) {
    swigfaissJNI.IndexPreTransform_add_with_ids(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(xids));
  }
  ...
  public void search(long n, SWIGTYPE_p_float x, long k, SWIGTYPE_p_float distances, SWIGTYPE_p_long_long labels) {
    swigfaissJNI.IndexPreTransform_search(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), k, SWIGTYPE_p_float.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels));
  }
  ...
  public void search_and_reconstruct(long n, SWIGTYPE_p_float x, long k, SWIGTYPE_p_float distances, SWIGTYPE_p_long_long labels, SWIGTYPE_p_float recons) {
    swigfaissJNI.IndexPreTransform_search_and_reconstruct(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), k, SWIGTYPE_p_float.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels), SWIGTYPE_p_float.getCPtr(recons));
  }

  public SWIGTYPE_p_float apply_chain(long n, SWIGTYPE_p_float x) {
    long cPtr = swigfaissJNI.IndexPreTransform_apply_chain(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x));
    return (cPtr == 0) ? null : new SWIGTYPE_p_float(cPtr, false);
  }

  public void reverse_chain(long n, SWIGTYPE_p_float xt, SWIGTYPE_p_float x) {
