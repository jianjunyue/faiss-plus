...
public class HNSW {
  ...
  static public class NodeDistCloser {
    ...
    public boolean __operator_lt__(HNSW.NodeDistCloser obj1) {
      return swigfaissJNI.HNSW_NodeDistCloser___operator_lt__(swigCPtr, this, HNSW.NodeDistCloser.getCPtr(obj1), obj1);
    }
  ...
  static public class NodeDistFarther {
    ...
    public boolean __operator_lt__(HNSW.NodeDistFarther obj1) {
      return swigfaissJNI.HNSW_NodeDistFarther___operator_lt__(swigCPtr, this, HNSW.NodeDistFarther.getCPtr(obj1), obj1);
    }
  ...
  public void setOffsets(SWIGTYPE_p_std__vectorT_long_long_t value) {
    swigfaissJNI.HNSW_offsets_set(swigCPtr, this, SWIGTYPE_p_std__vectorT_long_long_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__vectorT_long_long_t getOffsets() {
  ...
  public void neighbor_range(long no, int layer_no, SWIGTYPE_p_long_long begin, SWIGTYPE_p_long_long end) {
    swigfaissJNI.HNSW_neighbor_range(swigCPtr, this, no, layer_no, SWIGTYPE_p_long_long.getCPtr(begin), SWIGTYPE_p_long_long.getCPtr(end));
  }
  ...
  public int search_from_candidates(DistanceComputer qdis, int k, SWIGTYPE_p_long_long I, SWIGTYPE_p_float D, HNSW.MinimaxHeap candidates, VisitedTable vt, int level, int nres_in) {
    return swigfaissJNI.HNSW_search_from_candidates__SWIG_0(swigCPtr, this, DistanceComputer.getCPtr(qdis), qdis, k, SWIGTYPE_p_long_long.getCPtr(I), SWIGTYPE_p_float.getCPtr(D), HNSW.MinimaxHeap.getCPtr(candidates), candidates, VisitedTable.getCPtr(vt), vt, level, nres_in);
  }

  public int search_from_candidates(DistanceComputer qdis, int k, SWIGTYPE_p_long_long I, SWIGTYPE_p_float D, HNSW.MinimaxHeap candidates, VisitedTable vt, int level) {
    return swigfaissJNI.HNSW_search_from_candidates__SWIG_1(swigCPtr, this, DistanceComputer.getCPtr(qdis), qdis, k, SWIGTYPE_p_long_long.getCPtr(I), SWIGTYPE_p_float.getCPtr(D), HNSW.MinimaxHeap.getCPtr(candidates), candidates, VisitedTable.getCPtr(vt), vt, level);
  }
  ...
  public void search(DistanceComputer qdis, int k, SWIGTYPE_p_long_long I, SWIGTYPE_p_float D, VisitedTable vt) {
    swigfaissJNI.HNSW_search(swigCPtr, this, DistanceComputer.getCPtr(qdis), qdis, k, SWIGTYPE_p_long_long.getCPtr(I), SWIGTYPE_p_float.getCPtr(D), VisitedTable.getCPtr(vt), vt);
  }
