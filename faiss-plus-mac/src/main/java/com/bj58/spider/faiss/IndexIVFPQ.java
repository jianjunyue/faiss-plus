...
public class IndexIVFPQ extends IndexIVF {
  ...
  public IndexIVFPQ(Index quantizer, long d, long nlist, long M, long nbits_per_idx) {
    this(swigfaissJNI.new_IndexIVFPQ__SWIG_0(Index.getCPtr(quantizer), quantizer, d, nlist, M, nbits_per_idx), true);
  }

  public void add_with_ids(long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long xids) {
    swigfaissJNI.IndexIVFPQ_add_with_ids__SWIG_0(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(xids));
  }

  public void add_with_ids(long n, SWIGTYPE_p_float x) {
  ...
  public void encode_vectors(long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long list_nos, SWIGTYPE_p_unsigned_char codes) {
    swigfaissJNI.IndexIVFPQ_encode_vectors(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(list_nos), SWIGTYPE_p_unsigned_char.getCPtr(codes));
  }

  public void add_core_o(long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long xids, SWIGTYPE_p_float residuals_2, SWIGTYPE_p_long_long precomputed_idx) {
    swigfaissJNI.IndexIVFPQ_add_core_o__SWIG_0(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(xids), SWIGTYPE_p_float.getCPtr(residuals_2), SWIGTYPE_p_long_long.getCPtr(precomputed_idx));
  }

  public void add_core_o(long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long xids, SWIGTYPE_p_float residuals_2) {
    swigfaissJNI.IndexIVFPQ_add_core_o__SWIG_1(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(xids), SWIGTYPE_p_float.getCPtr(residuals_2));
  }
  ...
  public long find_duplicates(SWIGTYPE_p_long_long ids, SWIGTYPE_p_long_long lims) {
    return swigfaissJNI.IndexIVFPQ_find_duplicates(swigCPtr, this, SWIGTYPE_p_long_long.getCPtr(ids), SWIGTYPE_p_long_long.getCPtr(lims));
  }
  ...
  public void encode_multiple(long n, SWIGTYPE_p_long_long keys, SWIGTYPE_p_float x, SWIGTYPE_p_unsigned_char codes, boolean compute_keys) {
    swigfaissJNI.IndexIVFPQ_encode_multiple__SWIG_0(swigCPtr, this, n, SWIGTYPE_p_long_long.getCPtr(keys), SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_unsigned_char.getCPtr(codes), compute_keys);
  }

  public void encode_multiple(long n, SWIGTYPE_p_long_long keys, SWIGTYPE_p_float x, SWIGTYPE_p_unsigned_char codes) {
    swigfaissJNI.IndexIVFPQ_encode_multiple__SWIG_1(swigCPtr, this, n, SWIGTYPE_p_long_long.getCPtr(keys), SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_unsigned_char.getCPtr(codes));
  }

  public void decode_multiple(long n, SWIGTYPE_p_long_long keys, SWIGTYPE_p_unsigned_char xcodes, SWIGTYPE_p_float x) {
    swigfaissJNI.IndexIVFPQ_decode_multiple(swigCPtr, this, n, SWIGTYPE_p_long_long.getCPtr(keys), SWIGTYPE_p_unsigned_char.getCPtr(xcodes), SWIGTYPE_p_float.getCPtr(x));
  }
