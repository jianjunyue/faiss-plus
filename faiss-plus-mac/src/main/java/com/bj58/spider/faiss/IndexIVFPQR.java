...
public class IndexIVFPQR extends IndexIVFPQ {
  ...
  public void add_with_ids(long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long xids) {
    swigfaissJNI.IndexIVFPQR_add_with_ids(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(xids));
  }

  public void add_core(long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long xids, SWIGTYPE_p_long_long precomputed_idx) {
    swigfaissJNI.IndexIVFPQR_add_core__SWIG_0(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(xids), SWIGTYPE_p_long_long.getCPtr(precomputed_idx));
  }

  public void add_core(long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long xids) {
    swigfaissJNI.IndexIVFPQR_add_core__SWIG_1(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(xids));
  }
  ...
  public void search_preassigned(long n, SWIGTYPE_p_float x, long k, SWIGTYPE_p_long_long assign, SWIGTYPE_p_float centroid_dis, SWIGTYPE_p_float distances, SWIGTYPE_p_long_long labels, boolean store_pairs, IVFSearchParameters params) {
    swigfaissJNI.IndexIVFPQR_search_preassigned__SWIG_0(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), k, SWIGTYPE_p_long_long.getCPtr(assign), SWIGTYPE_p_float.getCPtr(centroid_dis), SWIGTYPE_p_float.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels), store_pairs, IVFSearchParameters.getCPtr(params), params);
  }
  ...
  public void search_preassigned(long n, SWIGTYPE_p_float x, long k, SWIGTYPE_p_long_long assign, SWIGTYPE_p_float centroid_dis, SWIGTYPE_p_float distances, SWIGTYPE_p_long_long labels, boolean store_pairs) {
    swigfaissJNI.IndexIVFPQR_search_preassigned__SWIG_1(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), k, SWIGTYPE_p_long_long.getCPtr(assign), SWIGTYPE_p_float.getCPtr(centroid_dis), SWIGTYPE_p_float.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels), store_pairs);
  }
