...
public class RangeSearchResult {
  ...
  public void setLims(SWIGTYPE_p_long_long value) {
    swigfaissJNI.RangeSearchResult_lims_set(swigCPtr, this, SWIGTYPE_p_long_long.getCPtr(value));
  }

  public SWIGTYPE_p_long_long getLims() {
    long cPtr = swigfaissJNI.RangeSearchResult_lims_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_long_long(cPtr, false);
  }

  public void setLabels(SWIGTYPE_p_long_long value) {
    swigfaissJNI.RangeSearchResult_labels_set(swigCPtr, this, SWIGTYPE_p_long_long.getCPtr(value));
  }

  public SWIGTYPE_p_long_long getLabels() {
