...
public class IndexBinary {
  ...
  public void add_with_ids(long n, SWIGTYPE_p_unsigned_char x, SWIGTYPE_p_long_long xids) {
    swigfaissJNI.IndexBinary_add_with_ids(swigCPtr, this, n, SWIGTYPE_p_unsigned_char.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(xids));
  }

  public void search(long n, SWIGTYPE_p_unsigned_char x, long k, SWIGTYPE_p_int distances, SWIGTYPE_p_long_long labels) {
    swigfaissJNI.IndexBinary_search(swigCPtr, this, n, SWIGTYPE_p_unsigned_char.getCPtr(x), k, SWIGTYPE_p_int.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels));
  }
  ...
  public void assign(long n, SWIGTYPE_p_unsigned_char x, SWIGTYPE_p_long_long labels, long k) {
    swigfaissJNI.IndexBinary_assign__SWIG_0(swigCPtr, this, n, SWIGTYPE_p_unsigned_char.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(labels), k);
  }

  public void assign(long n, SWIGTYPE_p_unsigned_char x, SWIGTYPE_p_long_long labels) {
    swigfaissJNI.IndexBinary_assign__SWIG_1(swigCPtr, this, n, SWIGTYPE_p_unsigned_char.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(labels));
  }
  ...
  public void search_and_reconstruct(long n, SWIGTYPE_p_unsigned_char x, long k, SWIGTYPE_p_int distances, SWIGTYPE_p_long_long labels, SWIGTYPE_p_unsigned_char recons) {
    swigfaissJNI.IndexBinary_search_and_reconstruct(swigCPtr, this, n, SWIGTYPE_p_unsigned_char.getCPtr(x), k, SWIGTYPE_p_int.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels), SWIGTYPE_p_unsigned_char.getCPtr(recons));
  }
