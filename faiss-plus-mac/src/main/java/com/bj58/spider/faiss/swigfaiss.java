...
public class swigfaiss implements swigfaissConstants {
  ...
  public static int popcount64(java.math.BigInteger x) {
  ...
  public static void hammings_knn_mc(SWIGTYPE_p_unsigned_char a, SWIGTYPE_p_unsigned_char b, long na, long nb, long k, long ncodes, SWIGTYPE_p_int distances, SWIGTYPE_p_long_long labels) {
    swigfaissJNI.hammings_knn_mc(SWIGTYPE_p_unsigned_char.getCPtr(a), SWIGTYPE_p_unsigned_char.getCPtr(b), na, nb, k, ncodes, SWIGTYPE_p_int.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels));
  }

  public static void hamming_count_thres(SWIGTYPE_p_unsigned_char bs1, SWIGTYPE_p_unsigned_char bs2, long n1, long n2, int ht, long ncodes, SWIGTYPE_p_long_long nptr) {
    swigfaissJNI.hamming_count_thres(SWIGTYPE_p_unsigned_char.getCPtr(bs1), SWIGTYPE_p_unsigned_char.getCPtr(bs2), n1, n2, ht, ncodes, SWIGTYPE_p_long_long.getCPtr(nptr));
  }

  public static long match_hamming_thres(SWIGTYPE_p_unsigned_char bs1, SWIGTYPE_p_unsigned_char bs2, long n1, long n2, int ht, long ncodes, SWIGTYPE_p_long_long idx, SWIGTYPE_p_int dis) {
    return swigfaissJNI.match_hamming_thres(SWIGTYPE_p_unsigned_char.getCPtr(bs1), SWIGTYPE_p_unsigned_char.getCPtr(bs2), n1, n2, ht, ncodes, SWIGTYPE_p_long_long.getCPtr(idx), SWIGTYPE_p_int.getCPtr(dis));
  }

  public static void crosshamming_count_thres(SWIGTYPE_p_unsigned_char dbs, long n, int ht, long ncodes, SWIGTYPE_p_long_long nptr) {
    swigfaissJNI.crosshamming_count_thres(SWIGTYPE_p_unsigned_char.getCPtr(dbs), n, ht, ncodes, SWIGTYPE_p_long_long.getCPtr(nptr));
  }

  public static int generalized_hamming_64(java.math.BigInteger a) {
    return swigfaissJNI.generalized_hamming_64(a);
  }

  public static void generalized_hammings_knn_hc(int_maxheap_array_t ha, SWIGTYPE_p_unsigned_char a, SWIGTYPE_p_unsigned_char b, long nb, long code_size, int ordered) {
    swigfaissJNI.generalized_hammings_knn_hc__SWIG_0(int_maxheap_array_t.getCPtr(ha), ha, SWIGTYPE_p_unsigned_char.getCPtr(a), SWIGTYPE_p_unsigned_char.getCPtr(b), nb, code_size, ordered);
  }

  public static void generalized_hammings_knn_hc(int_maxheap_array_t ha, SWIGTYPE_p_unsigned_char a, SWIGTYPE_p_unsigned_char b, long nb, long code_size) {
    swigfaissJNI.generalized_hammings_knn_hc__SWIG_1(int_maxheap_array_t.getCPtr(ha), ha, SWIGTYPE_p_unsigned_char.getCPtr(a), SWIGTYPE_p_unsigned_char.getCPtr(b), nb, code_size);
  }
  ...
  public static void float_rand(SWIGTYPE_p_float x, long n, long seed) {
    swigfaissJNI.float_rand(SWIGTYPE_p_float.getCPtr(x), n, seed);
  }

  public static void float_randn(SWIGTYPE_p_float x, long n, long seed) {
    swigfaissJNI.float_randn(SWIGTYPE_p_float.getCPtr(x), n, seed);
  }

  public static void int64_rand(SWIGTYPE_p_long_long x, long n, long seed) {
    swigfaissJNI.int64_rand(SWIGTYPE_p_long_long.getCPtr(x), n, seed);
  }

  public static void byte_rand(SWIGTYPE_p_unsigned_char x, long n, long seed) {
    swigfaissJNI.byte_rand(SWIGTYPE_p_unsigned_char.getCPtr(x), n, seed);
  }

  public static void rand_perm(SWIGTYPE_p_int perm, long n, long seed) {
  ...
  public static double imbalance_factor(int n, int k, SWIGTYPE_p_long_long assign) {
    return swigfaissJNI.imbalance_factor__SWIG_0(n, k, SWIGTYPE_p_long_long.getCPtr(assign));
  }
  ...
  public static void pairwise_L2sqr(long d, long nq, SWIGTYPE_p_float xq, long nb, SWIGTYPE_p_float xb, SWIGTYPE_p_float dis, long ldq, long ldb, long ldd) {
  ...
  public static void pairwise_L2sqr(long d, long nq, SWIGTYPE_p_float xq, long nb, SWIGTYPE_p_float xb, SWIGTYPE_p_float dis, long ldq, long ldb) {
  ...
  public static void pairwise_L2sqr(long d, long nq, SWIGTYPE_p_float xq, long nb, SWIGTYPE_p_float xb, SWIGTYPE_p_float dis, long ldq) {
  ...
  public static void pairwise_L2sqr(long d, long nq, SWIGTYPE_p_float xq, long nb, SWIGTYPE_p_float xb, SWIGTYPE_p_float dis) {
  ...
  public static void fvec_inner_products_by_idx(SWIGTYPE_p_float ip, SWIGTYPE_p_float x, SWIGTYPE_p_float y, SWIGTYPE_p_long_long ids, long d, long nx, long ny) {
    swigfaissJNI.fvec_inner_products_by_idx(SWIGTYPE_p_float.getCPtr(ip), SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_float.getCPtr(y), SWIGTYPE_p_long_long.getCPtr(ids), d, nx, ny);
  }

  public static void fvec_L2sqr_by_idx(SWIGTYPE_p_float dis, SWIGTYPE_p_float x, SWIGTYPE_p_float y, SWIGTYPE_p_long_long ids, long d, long nx, long ny) {
    swigfaissJNI.fvec_L2sqr_by_idx(SWIGTYPE_p_float.getCPtr(dis), SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_float.getCPtr(y), SWIGTYPE_p_long_long.getCPtr(ids), d, nx, ny);
  }
  ...
  public static void knn_inner_products_by_idx(SWIGTYPE_p_float x, SWIGTYPE_p_float y, SWIGTYPE_p_long_long ids, long d, long nx, long ny, float_minheap_array_t res) {
    swigfaissJNI.knn_inner_products_by_idx(SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_float.getCPtr(y), SWIGTYPE_p_long_long.getCPtr(ids), d, nx, ny, float_minheap_array_t.getCPtr(res), res);
  }

  public static void knn_L2sqr_by_idx(SWIGTYPE_p_float x, SWIGTYPE_p_float y, SWIGTYPE_p_long_long ids, long d, long nx, long ny, float_maxheap_array_t res) {
    swigfaissJNI.knn_L2sqr_by_idx(SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_float.getCPtr(y), SWIGTYPE_p_long_long.getCPtr(ids), d, nx, ny, float_maxheap_array_t.getCPtr(res), res);
  }
  ...
  public static int km_update_centroids(SWIGTYPE_p_float x, SWIGTYPE_p_float centroids, SWIGTYPE_p_long_long assign, long d, long k, long n, long k_frozen) {
    return swigfaissJNI.km_update_centroids(SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_float.getCPtr(centroids), SWIGTYPE_p_long_long.getCPtr(assign), d, k, n, k_frozen);
  }
  ...
  public static void ranklist_handle_ties(int k, SWIGTYPE_p_long_long idx, SWIGTYPE_p_float dis) {
    swigfaissJNI.ranklist_handle_ties(k, SWIGTYPE_p_long_long.getCPtr(idx), SWIGTYPE_p_float.getCPtr(dis));
  }

  public static long ranklist_intersection_size(long k1, SWIGTYPE_p_long_long v1, long k2, SWIGTYPE_p_long_long v2) {
    return swigfaissJNI.ranklist_intersection_size(k1, SWIGTYPE_p_long_long.getCPtr(v1), k2, SWIGTYPE_p_long_long.getCPtr(v2));
  }

  public static long merge_result_table_with(long n, long k, SWIGTYPE_p_long_long I0, SWIGTYPE_p_float D0, SWIGTYPE_p_long_long I1, SWIGTYPE_p_float D1, boolean keep_min, long translation) {
    return swigfaissJNI.merge_result_table_with__SWIG_0(n, k, SWIGTYPE_p_long_long.getCPtr(I0), SWIGTYPE_p_float.getCPtr(D0), SWIGTYPE_p_long_long.getCPtr(I1), SWIGTYPE_p_float.getCPtr(D1), keep_min, translation);
  }

  public static long merge_result_table_with(long n, long k, SWIGTYPE_p_long_long I0, SWIGTYPE_p_float D0, SWIGTYPE_p_long_long I1, SWIGTYPE_p_float D1, boolean keep_min) {
    return swigfaissJNI.merge_result_table_with__SWIG_1(n, k, SWIGTYPE_p_long_long.getCPtr(I0), SWIGTYPE_p_float.getCPtr(D0), SWIGTYPE_p_long_long.getCPtr(I1), SWIGTYPE_p_float.getCPtr(D1), keep_min);
  }

  public static long merge_result_table_with(long n, long k, SWIGTYPE_p_long_long I0, SWIGTYPE_p_float D0, SWIGTYPE_p_long_long I1, SWIGTYPE_p_float D1) {
    return swigfaissJNI.merge_result_table_with__SWIG_2(n, k, SWIGTYPE_p_long_long.getCPtr(I0), SWIGTYPE_p_float.getCPtr(D0), SWIGTYPE_p_long_long.getCPtr(I1), SWIGTYPE_p_float.getCPtr(D1));
  }

  public static void fvec_argsort(long n, SWIGTYPE_p_float vals, SWIGTYPE_p_long_long perm) {
    swigfaissJNI.fvec_argsort(n, SWIGTYPE_p_float.getCPtr(vals), SWIGTYPE_p_long_long.getCPtr(perm));
  }

  public static void fvec_argsort_parallel(long n, SWIGTYPE_p_float vals, SWIGTYPE_p_long_long perm) {
    swigfaissJNI.fvec_argsort_parallel(n, SWIGTYPE_p_float.getCPtr(vals), SWIGTYPE_p_long_long.getCPtr(perm));
  }
  ...
  public static SWIGTYPE_p_float fvecs_maybe_subsample(long d, SWIGTYPE_p_long_long n, long nmax, SWIGTYPE_p_float x, boolean verbose, long seed) {
    long cPtr = swigfaissJNI.fvecs_maybe_subsample__SWIG_0(d, SWIGTYPE_p_long_long.getCPtr(n), nmax, SWIGTYPE_p_float.getCPtr(x), verbose, seed);
    return (cPtr == 0) ? null : new SWIGTYPE_p_float(cPtr, false);
  }

  public static SWIGTYPE_p_float fvecs_maybe_subsample(long d, SWIGTYPE_p_long_long n, long nmax, SWIGTYPE_p_float x, boolean verbose) {
    long cPtr = swigfaissJNI.fvecs_maybe_subsample__SWIG_1(d, SWIGTYPE_p_long_long.getCPtr(n), nmax, SWIGTYPE_p_float.getCPtr(x), verbose);
    return (cPtr == 0) ? null : new SWIGTYPE_p_float(cPtr, false);
  }

  public static SWIGTYPE_p_float fvecs_maybe_subsample(long d, SWIGTYPE_p_long_long n, long nmax, SWIGTYPE_p_float x) {
    long cPtr = swigfaissJNI.fvecs_maybe_subsample__SWIG_2(d, SWIGTYPE_p_long_long.getCPtr(n), nmax, SWIGTYPE_p_float.getCPtr(x));
    return (cPtr == 0) ? null : new SWIGTYPE_p_float(cPtr, false);
  }
  ...
  public static java.math.BigInteger hash_bytes(SWIGTYPE_p_unsigned_char bytes, long n) {
  ...
  public static void pairwise_extra_distances(long d, long nq, SWIGTYPE_p_float xq, long nb, SWIGTYPE_p_float xb, MetricType mt, float metric_arg, SWIGTYPE_p_float dis, long ldq, long ldb, long ldd) {
  ...
  public static void pairwise_extra_distances(long d, long nq, SWIGTYPE_p_float xq, long nb, SWIGTYPE_p_float xb, MetricType mt, float metric_arg, SWIGTYPE_p_float dis, long ldq, long ldb) {
  ...
  public static void pairwise_extra_distances(long d, long nq, SWIGTYPE_p_float xq, long nb, SWIGTYPE_p_float xb, MetricType mt, float metric_arg, SWIGTYPE_p_float dis, long ldq) {
  ...
  public static void pairwise_extra_distances(long d, long nq, SWIGTYPE_p_float xq, long nb, SWIGTYPE_p_float xb, MetricType mt, float metric_arg, SWIGTYPE_p_float dis) {
  ...
  public static void search_centroid(Index index, SWIGTYPE_p_float x, int n, SWIGTYPE_p_long_long centroid_ids) {
    swigfaissJNI.search_centroid(Index.getCPtr(index), index, SWIGTYPE_p_float.getCPtr(x), n, SWIGTYPE_p_long_long.getCPtr(centroid_ids));
  }

  public static void search_and_return_centroids(Index index, long n, SWIGTYPE_p_float xin, int k, SWIGTYPE_p_float distances, SWIGTYPE_p_long_long labels, SWIGTYPE_p_long_long query_centroid_ids, SWIGTYPE_p_long_long result_centroid_ids) {
    swigfaissJNI.search_and_return_centroids(Index.getCPtr(index), index, n, SWIGTYPE_p_float.getCPtr(xin), k, SWIGTYPE_p_float.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels), SWIGTYPE_p_long_long.getCPtr(query_centroid_ids), SWIGTYPE_p_long_long.getCPtr(result_centroid_ids));
  }
  ...
  public static void search_with_parameters(Index index, long n, SWIGTYPE_p_float x, long k, SWIGTYPE_p_float distances, SWIGTYPE_p_long_long labels, IVFSearchParameters params) {
    swigfaissJNI.search_with_parameters(Index.getCPtr(index), index, n, SWIGTYPE_p_float.getCPtr(x), k, SWIGTYPE_p_float.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels), IVFSearchParameters.getCPtr(params), params);
  }
