...
public class MatrixStats {
  ...
  public void setOccurrences(SWIGTYPE_p_std__unordered_mapT_unsigned_long_long_faiss__MatrixStats__Occurrence_t value) {
    swigfaissJNI.MatrixStats_occurrences_set(swigCPtr, this, SWIGTYPE_p_std__unordered_mapT_unsigned_long_long_faiss__MatrixStats__Occurrence_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__unordered_mapT_unsigned_long_long_faiss__MatrixStats__Occurrence_t getOccurrences() {
    long cPtr = swigfaissJNI.MatrixStats_occurrences_get(swigCPtr, this);
    return (cPtr == 0) ? null : new SWIGTYPE_p_std__unordered_mapT_unsigned_long_long_faiss__MatrixStats__Occurrence_t(cPtr, false);
  }
