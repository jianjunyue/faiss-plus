...
public class IndexBinaryIDMap2 extends IndexBinaryIDMap {
  ...
  public void setRev_map(SWIGTYPE_p_std__unordered_mapT_long_long_long_long_t value) {
    swigfaissJNI.IndexBinaryIDMap2_rev_map_set(swigCPtr, this, SWIGTYPE_p_std__unordered_mapT_long_long_long_long_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__unordered_mapT_long_long_long_long_t getRev_map() {
    return new SWIGTYPE_p_std__unordered_mapT_long_long_long_long_t(swigfaissJNI.IndexBinaryIDMap2_rev_map_get(swigCPtr, this), true);
  }
  ...
  public void add_with_ids(long n, SWIGTYPE_p_unsigned_char x, SWIGTYPE_p_long_long xids) {
    swigfaissJNI.IndexBinaryIDMap2_add_with_ids(swigCPtr, this, n, SWIGTYPE_p_unsigned_char.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(xids));
  }
