...
public class HNSW {
  ...
  static public class DistanceComputer {
    private transient long swigCPtr;
    protected transient boolean swigCMemOwn;
    ...
    public synchronized void delete() {
      if (swigCPtr != 0) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          swigfaissJNI.delete_HNSW_DistanceComputer(swigCPtr);
        }
        swigCPtr = 0;
      }
    }
    ...
    public void setD(int value) {
      swigfaissJNI.HNSW_DistanceComputer_d_set(swigCPtr, this, value);
    }
  
    public int getD() {
      return swigfaissJNI.HNSW_DistanceComputer_d_get(swigCPtr, this);
    }
  
    public void set_query(SWIGTYPE_p_float x) {
      swigfaissJNI.HNSW_DistanceComputer_set_query(swigCPtr, this, SWIGTYPE_p_float.getCPtr(x));
    }
  
    public float symmetric_dis(int i, int j) {
      return swigfaissJNI.HNSW_DistanceComputer_symmetric_dis(swigCPtr, this, i, j);
    }
  ...
  public void add_links_starting_from(HNSW.DistanceComputer ptdis, int pt_id, int nearest, float d_nearest, int level, SWIGTYPE_p_omp_lock_t locks, VisitedTable vt) {
    swigfaissJNI.HNSW_add_links_starting_from(swigCPtr, this, HNSW.DistanceComputer.getCPtr(ptdis), ptdis, pt_id, nearest, d_nearest, level, SWIGTYPE_p_omp_lock_t.getCPtr(locks), VisitedTable.getCPtr(vt), vt);
  }

  public void add_with_locks(HNSW.DistanceComputer ptdis, int pt_level, int pt_id, SWIGTYPE_p_std__vectorT_omp_lock_t_t locks, VisitedTable vt) {
    swigfaissJNI.HNSW_add_with_locks(swigCPtr, this, HNSW.DistanceComputer.getCPtr(ptdis), ptdis, pt_level, pt_id, SWIGTYPE_p_std__vectorT_omp_lock_t_t.getCPtr(locks), VisitedTable.getCPtr(vt), vt);
  }

  public int search_from_candidates(HNSW.DistanceComputer qdis, int k, SWIGTYPE_p_long I, SWIGTYPE_p_float D, HNSW.MinimaxHeap candidates, VisitedTable vt, int level, int nres_in) {
    return swigfaissJNI.HNSW_search_from_candidates__SWIG_0(swigCPtr, this, HNSW.DistanceComputer.getCPtr(qdis), qdis, k, SWIGTYPE_p_long.getCPtr(I), SWIGTYPE_p_float.getCPtr(D), HNSW.MinimaxHeap.getCPtr(candidates), candidates, VisitedTable.getCPtr(vt), vt, level, nres_in);
  }

  public int search_from_candidates(HNSW.DistanceComputer qdis, int k, SWIGTYPE_p_long I, SWIGTYPE_p_float D, HNSW.MinimaxHeap candidates, VisitedTable vt, int level) {
    return swigfaissJNI.HNSW_search_from_candidates__SWIG_1(swigCPtr, this, HNSW.DistanceComputer.getCPtr(qdis), qdis, k, SWIGTYPE_p_long.getCPtr(I), SWIGTYPE_p_float.getCPtr(D), HNSW.MinimaxHeap.getCPtr(candidates), candidates, VisitedTable.getCPtr(vt), vt, level);
  }

  public SWIGTYPE_p_std__priority_queueT_std__pairT_float_int_t_t search_from(SWIGTYPE_p_std__pairT_float_int_t node, HNSW.DistanceComputer qdis, int ef, VisitedTable vt) {
    return new SWIGTYPE_p_std__priority_queueT_std__pairT_float_int_t_t(swigfaissJNI.HNSW_search_from(swigCPtr, this, SWIGTYPE_p_std__pairT_float_int_t.getCPtr(node), HNSW.DistanceComputer.getCPtr(qdis), qdis, ef, VisitedTable.getCPtr(vt), vt), true);
  }

  public void search(HNSW.DistanceComputer qdis, int k, SWIGTYPE_p_long I, SWIGTYPE_p_float D, VisitedTable vt) {
    swigfaissJNI.HNSW_search(swigCPtr, this, HNSW.DistanceComputer.getCPtr(qdis), qdis, k, SWIGTYPE_p_long.getCPtr(I), SWIGTYPE_p_float.getCPtr(D), VisitedTable.getCPtr(vt), vt);
  }
  ...
  public static void shrink_neighbor_list(HNSW.DistanceComputer qdis, SWIGTYPE_p_std__priority_queueT_faiss__HNSW__NodeDistFarther_t input, SWIGTYPE_p_std__vectorT_faiss__HNSW__NodeDistFarther_t output, int max_size) {
    swigfaissJNI.HNSW_shrink_neighbor_list(HNSW.DistanceComputer.getCPtr(qdis), qdis, SWIGTYPE_p_std__priority_queueT_faiss__HNSW__NodeDistFarther_t.getCPtr(input), SWIGTYPE_p_std__vectorT_faiss__HNSW__NodeDistFarther_t.getCPtr(output), max_size);
  }
