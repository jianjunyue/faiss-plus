...
public class swigfaiss implements swigfaissConstants {
  ...
  public static void long_rand(SWIGTYPE_p_long x, long n, int seed) {
    swigfaissJNI.long_rand(SWIGTYPE_p_long.getCPtr(x), n, seed);
  }
  ...
  public static int km_update_centroids(SWIGTYPE_p_float x, SWIGTYPE_p_float centroids, SWIGTYPE_p_long assign, long d, long k, long n, long k_frozen) {
    return swigfaissJNI.km_update_centroids(SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_float.getCPtr(centroids), SWIGTYPE_p_long.getCPtr(assign), d, k, n, k_frozen);
  }
  ...
  public static void search_with_parameters(Index index, int n, SWIGTYPE_p_float x, int k, SWIGTYPE_p_float distances, SWIGTYPE_p_long labels, IVFSearchParameters params) {
    swigfaissJNI.search_with_parameters(Index.getCPtr(index), index, n, SWIGTYPE_p_float.getCPtr(x), k, SWIGTYPE_p_float.getCPtr(distances), SWIGTYPE_p_long.getCPtr(labels), IVFSearchParameters.getCPtr(params), params);
  }
