...
public class IndexIVF extends Index {
  ...
  public void encode_vectors(int n, SWIGTYPE_p_float x, SWIGTYPE_p_long list_nos, SWIGTYPE_p_unsigned_char codes) {
    swigfaissJNI.IndexIVF_encode_vectors(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long.getCPtr(list_nos), SWIGTYPE_p_unsigned_char.getCPtr(codes));
  }
  ...
  public double imbalance_factor() {
    return swigfaissJNI.IndexIVF_imbalance_factor(swigCPtr, this);
  }

  public void print_stats() {
    swigfaissJNI.IndexIVF_print_stats(swigCPtr, this);
  }
