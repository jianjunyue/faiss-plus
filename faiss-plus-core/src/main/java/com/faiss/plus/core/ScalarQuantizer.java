...
public class ScalarQuantizer {
  ...
  static public class DistanceComputer {
    ...
    public synchronized void delete() {
      if (swigCPtr != 0) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          swigfaissJNI.delete_ScalarQuantizer_DistanceComputer(swigCPtr);
        }
        swigCPtr = 0;
      }
    }
  
    public float compute_distance(SWIGTYPE_p_float x, SWIGTYPE_p_unsigned_char code) {
      return swigfaissJNI.ScalarQuantizer_DistanceComputer_compute_distance(swigCPtr, this, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_unsigned_char.getCPtr(code));
    }
  
    public float compute_code_distance(SWIGTYPE_p_unsigned_char code1, SWIGTYPE_p_unsigned_char code2) {
      return swigfaissJNI.ScalarQuantizer_DistanceComputer_compute_code_distance(swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(code1), SWIGTYPE_p_unsigned_char.getCPtr(code2));
    }
  
  }

  public ScalarQuantizer.DistanceComputer get_distance_computer(MetricType metric) {
    long cPtr = swigfaissJNI.ScalarQuantizer_get_distance_computer__SWIG_0(swigCPtr, this, metric.swigValue());
    return (cPtr == 0) ? null : new ScalarQuantizer.DistanceComputer(cPtr, false);
  }

  public ScalarQuantizer.DistanceComputer get_distance_computer() {
  ...
  public final static class QuantizerType {
    ...
    private static QuantizerType[] swigValues = { QT_8bit, QT_4bit, QT_8bit_uniform, QT_4bit_uniform, QT_fp16 };
