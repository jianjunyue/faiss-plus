...
public class float_minheap_array_t {
  ...
  public void setIds(SWIGTYPE_p_long value) {
    swigfaissJNI.float_minheap_array_t_ids_set(swigCPtr, this, SWIGTYPE_p_long.getCPtr(value));
  }
  ...
  public void addn_with_ids(long nj, SWIGTYPE_p_float vin, SWIGTYPE_p_long id_in, int id_stride, long i0, int ni) {
    swigfaissJNI.float_minheap_array_t_addn_with_ids__SWIG_0(swigCPtr, this, nj, SWIGTYPE_p_float.getCPtr(vin), SWIGTYPE_p_long.getCPtr(id_in), id_stride, i0, ni);
  }

  public void addn_with_ids(long nj, SWIGTYPE_p_float vin, SWIGTYPE_p_long id_in, int id_stride, long i0) {
    swigfaissJNI.float_minheap_array_t_addn_with_ids__SWIG_1(swigCPtr, this, nj, SWIGTYPE_p_float.getCPtr(vin), SWIGTYPE_p_long.getCPtr(id_in), id_stride, i0);
  }

  public void addn_with_ids(long nj, SWIGTYPE_p_float vin, SWIGTYPE_p_long id_in, int id_stride) {
    swigfaissJNI.float_minheap_array_t_addn_with_ids__SWIG_2(swigCPtr, this, nj, SWIGTYPE_p_float.getCPtr(vin), SWIGTYPE_p_long.getCPtr(id_in), id_stride);
  }

  public void addn_with_ids(long nj, SWIGTYPE_p_float vin, SWIGTYPE_p_long id_in) {
    swigfaissJNI.float_minheap_array_t_addn_with_ids__SWIG_3(swigCPtr, this, nj, SWIGTYPE_p_float.getCPtr(vin), SWIGTYPE_p_long.getCPtr(id_in));
  }
  ...
  public void per_line_extrema(SWIGTYPE_p_float vals_out, SWIGTYPE_p_long idx_out) {
    swigfaissJNI.float_minheap_array_t_per_line_extrema(swigCPtr, this, SWIGTYPE_p_float.getCPtr(vals_out), SWIGTYPE_p_long.getCPtr(idx_out));
  }
