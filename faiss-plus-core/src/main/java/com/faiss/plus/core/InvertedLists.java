...
public class InvertedLists {
  ...
  public void release_codes(SWIGTYPE_p_unsigned_char codes) {
    swigfaissJNI.InvertedLists_release_codes(swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(codes));
  }

  public void release_ids(SWIGTYPE_p_long ids) {
    swigfaissJNI.InvertedLists_release_ids(swigCPtr, this, SWIGTYPE_p_long.getCPtr(ids));
  }
