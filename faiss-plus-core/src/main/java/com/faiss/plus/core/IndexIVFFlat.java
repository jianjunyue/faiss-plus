...
public class IndexIVFFlat extends IndexIVF {
  ...
  public void encode_vectors(int n, SWIGTYPE_p_float x, SWIGTYPE_p_long list_nos, SWIGTYPE_p_unsigned_char codes) {
    swigfaissJNI.IndexIVFFlat_encode_vectors(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long.getCPtr(list_nos), SWIGTYPE_p_unsigned_char.getCPtr(codes));
  }
  ...
  public void range_search(int n, SWIGTYPE_p_float x, float radius, RangeSearchResult result) {
    swigfaissJNI.IndexIVFFlat_range_search(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), radius, RangeSearchResult.getCPtr(result), result);
  }

  public void update_vectors(int nv, SWIGTYPE_p_long idx, SWIGTYPE_p_float v) {
    swigfaissJNI.IndexIVFFlat_update_vectors(swigCPtr, this, nv, SWIGTYPE_p_long.getCPtr(idx), SWIGTYPE_p_float.getCPtr(v));
  }
