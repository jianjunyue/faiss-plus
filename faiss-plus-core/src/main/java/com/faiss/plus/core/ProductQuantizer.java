...
public class ProductQuantizer {
  ...
  public void setByte_per_idx(long value) {
    swigfaissJNI.ProductQuantizer_byte_per_idx_set(swigCPtr, this, value);
  }

  public long getByte_per_idx() {
    return swigfaissJNI.ProductQuantizer_byte_per_idx_get(swigCPtr, this);
  }
