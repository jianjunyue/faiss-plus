...
public class IndexIVFFlat extends IndexIVF {
  ...
  public void add_core(long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long xids, SWIGTYPE_p_long_long precomputed_idx) {
    swigfaissJNI.IndexIVFFlat_add_core(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(xids), SWIGTYPE_p_long_long.getCPtr(precomputed_idx));
  }

  public void add_with_ids(long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long xids) {
    swigfaissJNI.IndexIVFFlat_add_with_ids(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(xids));
  }

  public void encode_vectors(long n, SWIGTYPE_p_float x, SWIGTYPE_p_long_long list_nos, SWIGTYPE_p_unsigned_char codes) {
    swigfaissJNI.IndexIVFFlat_encode_vectors(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), SWIGTYPE_p_long_long.getCPtr(list_nos), SWIGTYPE_p_unsigned_char.getCPtr(codes));
  }
  ...
  public void update_vectors(int nv, SWIGTYPE_p_long_long idx, SWIGTYPE_p_float v) {
    swigfaissJNI.IndexIVFFlat_update_vectors(swigCPtr, this, nv, SWIGTYPE_p_long_long.getCPtr(idx), SWIGTYPE_p_float.getCPtr(v));
  }
