...
public class AutoTuneCriterion {
  ...
  public void setGt_I(SWIGTYPE_p_std__vectorT_long_long_t value) {
    swigfaissJNI.AutoTuneCriterion_gt_I_set(swigCPtr, this, SWIGTYPE_p_std__vectorT_long_long_t.getCPtr(value));
  }

  public SWIGTYPE_p_std__vectorT_long_long_t getGt_I() {
  ...
  public void set_groundtruth(int gt_nnn, SWIGTYPE_p_float gt_D_in, SWIGTYPE_p_long_long gt_I_in) {
    swigfaissJNI.AutoTuneCriterion_set_groundtruth(swigCPtr, this, gt_nnn, SWIGTYPE_p_float.getCPtr(gt_D_in), SWIGTYPE_p_long_long.getCPtr(gt_I_in));
  }

  public double evaluate(SWIGTYPE_p_float D, SWIGTYPE_p_long_long I) {
    return swigfaissJNI.AutoTuneCriterion_evaluate(swigCPtr, this, SWIGTYPE_p_float.getCPtr(D), SWIGTYPE_p_long_long.getCPtr(I));
  }
