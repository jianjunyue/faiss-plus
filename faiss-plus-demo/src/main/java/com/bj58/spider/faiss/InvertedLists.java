...
public class InvertedLists {
  ...
  public SWIGTYPE_p_long_long get_ids(long list_no) {
    long cPtr = swigfaissJNI.InvertedLists_get_ids(swigCPtr, this, list_no);
  ...
  public void release_ids(long list_no, SWIGTYPE_p_long_long ids) {
    swigfaissJNI.InvertedLists_release_ids(swigCPtr, this, list_no, SWIGTYPE_p_long_long.getCPtr(ids));
  }
  ...
  public void prefetch_lists(SWIGTYPE_p_long_long list_nos, int nlist) {
    swigfaissJNI.InvertedLists_prefetch_lists(swigCPtr, this, SWIGTYPE_p_long_long.getCPtr(list_nos), nlist);
  }
  ...
  public long add_entries(long list_no, long n_entry, SWIGTYPE_p_long_long ids, SWIGTYPE_p_unsigned_char code) {
    return swigfaissJNI.InvertedLists_add_entries(swigCPtr, this, list_no, n_entry, SWIGTYPE_p_long_long.getCPtr(ids), SWIGTYPE_p_unsigned_char.getCPtr(code));
  }
  ...
  public void update_entries(long list_no, long offset, long n_entry, SWIGTYPE_p_long_long ids, SWIGTYPE_p_unsigned_char code) {
    swigfaissJNI.InvertedLists_update_entries(swigCPtr, this, list_no, offset, n_entry, SWIGTYPE_p_long_long.getCPtr(ids), SWIGTYPE_p_unsigned_char.getCPtr(code));
  }
  ...
  static public class ScopedIds {
    ...
    public void setIds(SWIGTYPE_p_long_long value) {
      swigfaissJNI.InvertedLists_ScopedIds_ids_set(swigCPtr, this, SWIGTYPE_p_long_long.getCPtr(value));
    }
    ...
    public SWIGTYPE_p_long_long get() {
      long cPtr = swigfaissJNI.InvertedLists_ScopedIds_get(swigCPtr, this);
      return (cPtr == 0) ? null : new SWIGTYPE_p_long_long(cPtr, false);
    }
  
    public long __operator_middle__(long i) {
      return swigfaissJNI.InvertedLists_ScopedIds___operator_middle__(swigCPtr, this, i);
    }
