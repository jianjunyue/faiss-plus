...
public class Index2Layer extends Index {
  ...
  public void setQ1(Level1Quantizer value) {
    swigfaissJNI.Index2Layer_q1_set(swigCPtr, this, (value == null) ? 0 : value.Level1Quantizer_GetInterfaceCPtr(), value);
  }

  public Level1Quantizer getQ1() {
    long cPtr = swigfaissJNI.Index2Layer_q1_get(swigCPtr, this);
    return (cPtr == 0) ? null : (Level1Quantizer)new Level1QuantizerSwigImpl(cPtr, false);
  }
  ...
  public Index2Layer(Index quantizer, long nlist, int M, MetricType metric) {
    this(swigfaissJNI.new_Index2Layer__SWIG_0(Index.getCPtr(quantizer), quantizer, nlist, M, metric.swigValue()), true);
  }

  public Index2Layer(Index quantizer, long nlist, int M) {
    this(swigfaissJNI.new_Index2Layer__SWIG_1(Index.getCPtr(quantizer), quantizer, nlist, M), true);
  }

  public Index2Layer() {
    this(swigfaissJNI.new_Index2Layer__SWIG_2(), true);
  }
  ...
  public void search(long n, SWIGTYPE_p_float x, long k, SWIGTYPE_p_float distances, SWIGTYPE_p_long_long labels) {
    swigfaissJNI.Index2Layer_search(swigCPtr, this, n, SWIGTYPE_p_float.getCPtr(x), k, SWIGTYPE_p_float.getCPtr(distances), SWIGTYPE_p_long_long.getCPtr(labels));
  }
