...
public class ReconstructFromNeighbors {
  ...
  public long compute_distances(long n, SWIGTYPE_p_long_long shortlist, SWIGTYPE_p_float query, SWIGTYPE_p_float distances) {
    return swigfaissJNI.ReconstructFromNeighbors_compute_distances(swigCPtr, this, n, SWIGTYPE_p_long_long.getCPtr(shortlist), SWIGTYPE_p_float.getCPtr(query), SWIGTYPE_p_float.getCPtr(distances));
  }
