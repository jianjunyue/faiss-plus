...
public class SliceInvertedLists extends ReadOnlyInvertedLists {
  ...
  public void release_ids(long list_no, SWIGTYPE_p_long_long ids) {
    swigfaissJNI.SliceInvertedLists_release_ids(swigCPtr, this, list_no, SWIGTYPE_p_long_long.getCPtr(ids));
  }
  ...
  public void prefetch_lists(SWIGTYPE_p_long_long list_nos, int nlist) {
    swigfaissJNI.SliceInvertedLists_prefetch_lists(swigCPtr, this, SWIGTYPE_p_long_long.getCPtr(list_nos), nlist);
  }
