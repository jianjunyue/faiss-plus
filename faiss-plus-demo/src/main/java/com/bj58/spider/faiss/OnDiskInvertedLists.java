...
public class OnDiskInvertedLists extends InvertedLists {
  ...
  public long add_entries(long list_no, long n_entry, SWIGTYPE_p_long_long ids, SWIGTYPE_p_unsigned_char code) {
    return swigfaissJNI.OnDiskInvertedLists_add_entries(swigCPtr, this, list_no, n_entry, SWIGTYPE_p_long_long.getCPtr(ids), SWIGTYPE_p_unsigned_char.getCPtr(code));
  }

  public void update_entries(long list_no, long offset, long n_entry, SWIGTYPE_p_long_long ids, SWIGTYPE_p_unsigned_char code) {
    swigfaissJNI.OnDiskInvertedLists_update_entries(swigCPtr, this, list_no, offset, n_entry, SWIGTYPE_p_long_long.getCPtr(ids), SWIGTYPE_p_unsigned_char.getCPtr(code));
  }
  ...
  public void prefetch_lists(SWIGTYPE_p_long_long list_nos, int nlist) {
    swigfaissJNI.OnDiskInvertedLists_prefetch_lists(swigCPtr, this, SWIGTYPE_p_long_long.getCPtr(list_nos), nlist);
  }
