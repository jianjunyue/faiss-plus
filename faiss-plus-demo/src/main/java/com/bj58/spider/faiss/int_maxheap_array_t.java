...
public class int_maxheap_array_t {
  ...
  public void setIds(SWIGTYPE_p_long_long value) {
    swigfaissJNI.int_maxheap_array_t_ids_set(swigCPtr, this, SWIGTYPE_p_long_long.getCPtr(value));
  }
  ...
  public void addn_with_ids(long nj, SWIGTYPE_p_int vin, SWIGTYPE_p_long_long id_in, long id_stride, long i0, long ni) {
    swigfaissJNI.int_maxheap_array_t_addn_with_ids__SWIG_0(swigCPtr, this, nj, SWIGTYPE_p_int.getCPtr(vin), SWIGTYPE_p_long_long.getCPtr(id_in), id_stride, i0, ni);
  }

  public void addn_with_ids(long nj, SWIGTYPE_p_int vin, SWIGTYPE_p_long_long id_in, long id_stride, long i0) {
    swigfaissJNI.int_maxheap_array_t_addn_with_ids__SWIG_1(swigCPtr, this, nj, SWIGTYPE_p_int.getCPtr(vin), SWIGTYPE_p_long_long.getCPtr(id_in), id_stride, i0);
  }

  public void addn_with_ids(long nj, SWIGTYPE_p_int vin, SWIGTYPE_p_long_long id_in, long id_stride) {
    swigfaissJNI.int_maxheap_array_t_addn_with_ids__SWIG_2(swigCPtr, this, nj, SWIGTYPE_p_int.getCPtr(vin), SWIGTYPE_p_long_long.getCPtr(id_in), id_stride);
  }

  public void addn_with_ids(long nj, SWIGTYPE_p_int vin, SWIGTYPE_p_long_long id_in) {
    swigfaissJNI.int_maxheap_array_t_addn_with_ids__SWIG_3(swigCPtr, this, nj, SWIGTYPE_p_int.getCPtr(vin), SWIGTYPE_p_long_long.getCPtr(id_in));
  }
  ...
  public void per_line_extrema(SWIGTYPE_p_int vals_out, SWIGTYPE_p_long_long idx_out) {
    swigfaissJNI.int_maxheap_array_t_per_line_extrema(swigCPtr, this, SWIGTYPE_p_int.getCPtr(vals_out), SWIGTYPE_p_long_long.getCPtr(idx_out));
  }
